...
<body>
    ...
    <div class="banner">
        ...
        <!-- Venture outside your comfort zone the rewards areworth it. -->
        <div class="bigt">
            <h2 id="text" class="container-fluid">VENTURE OUTSIDE YOUR CONFORT ZONE<br>&nbsp;&nbsp;&nbsp;THE REWARDS ARE WORTH IT.</h2>
        </div>
        <div class="clouds">
    ...
    <div class="for_all_bg">
        ...
        <div class="main_block">
            ...
            <div class="introduction">
                <div class="intro_title text-left col-12 position-relative" id="intro" data-aos="fade-right" data-aos-delay="170" data-aos-duration="1000">Introduction...
                ...
                <div class="intro_contents row align-items-center">
                    ...
                    <div class="intro_text col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 p-4">
                        <!-- <div class="intro_h3 text-right">About me</div><br> -->
                        我是
                        <span id="intro_name">
                            <?= $bis[0]['name'] ?>
                        </span>,
            ...
            <div class="work_experience">
                ...
                ?>
                <div class="work_title col-12 text-right" id="wk" data-aos="fade-left" data-aos-delay="170" data-aos-duration="1000">Work Experience.
            ...
            <div class="skills">
                <div class="skill_title text-left col-12" id="skill" data-aos="fade-right" data-aos-delay="170" data-aos-duration="1000">Skills...
                    <div class="intro_line"></div>
                </div>
            ...
            <!-- 作品 -->
            <div class="portfolio" id="por">
                <div class="por_title col-12 text-right" data-text="Contact Me." id="por" data-aos="fade-left" data-aos-delay="170" data-aos-duration="1000">Portfolio.
                    <div class="work_line"></div>
                </div>

<div class="por_text">
<select id="selecter"  class="js-example-disabled-results">
    <option value="all" <?=(isset($_GET['type']) && 'all'==$_GET['type'])?'selected':''?>>全部</option>
    <option value="frontend" <?=(isset($_GET['type']) && 'frontend'==$_GET['type'])?'selected':''?>>前端作品</option>
    <option value="backend" <?=(isset($_GET['type']) && 'backend'==$_GET['type'])?'selected':''?>>後端作品</option>
</select>
</div>
                <div class="por_content">

                    <?php
                    $pors = $Por->qall(($_SESSION['select'])??"select * from `resume_porfolio` where `sh`='1' order by rank");
...
<script>
    ...
    $("#selecter").change(function(){
        ...
        $.post('api/select.php',{selecttype},function(re){
            location.href="?type="+re;
        })
    })
...
<!-- <script>location.hash="#por";</script> -->

<?php
if(!empty($_SESSION['rungoto'])){
    echo '<script>location.hash="#por";</script>';
    unset($_SESSION['rungoto']);
};
?>