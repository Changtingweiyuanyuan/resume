...
?>
    ...
    <div id="loginblock" style="display:none;">
        <a onclick="cl('#loginblock')"
            style="position:absolute; right:10px; top:5px; cursor:pointer; z-index:9999; color:white;">X</a>
    ...
    <div class="banner">
        ...
        <div class="bigt">
            <h2 id="text" class="container-fluid">Venture outside your comfort zone<br>&nbsp;&nbsp;&nbsp;the rewards are
                worth it.</h2>
        </div>
        <div class="clouds">
    ...
    <div class="for_all_bg">
        ...
        <div class="main_block">
            <div class="introduction">
                <p class="intro_title text-left col-12" id="intro" data-aos="fade-right" data-aos-delay="170"
...
?>
            ...
            ?>
                        <img src="self_pic/<?=$pic['img'];?>" data-aos="zoom-in" data-aos-delay="200"
...
?>
                <p class="work_title col-12 text-right" id="wk" data-aos="fade-left" data-aos-delay="170"
                    data-aos-duration="1000">Work Experience.</p>
            ...
            <div class="skills">
                <p class="skill_title text-left col-12" id="skill" data-aos="fade-right" data-aos-delay="170"
                    data-aos-duration="1000">Skills...</p>
...
?>
                <div class="skill_content">
                    <!-- 技能文字介紹 -->
                    <div class="skill_front col-sm-12 col-md-12 col-lg-6 col-xl-6" data-aos="fade-right"
                ...
                ?>
                    ...
                    <div class="skill_backend col-sm-12 col-md-12 col-lg-6 col-xl-6" data-aos="fade-left"
                        data-aos-delay="200" data-aos-duration="800">
                        <div class="skill_symtitle">
                            <i class="fa fa-heart-o" aria-hidden="true"></i>
                ...
                ?>
                    ...
                    <div class="skill_graphic col-sm-12 col-md-12 col-lg-6 col-xl-6" data-aos="fade-right"
                        data-aos-delay="200" data-aos-duration="800">
                        <div class="skill_symtitle">
                            <i class="fa fa-heart-o" aria-hidden="true"></i>
                ...
                ?>
                    ...
                    <div class="skill_others col-sm-12 col-md-12 col-lg-6 col-xl-6" data-aos="fade-left"
                        data-aos-delay="200" data-aos-duration="800">
                        <div class="skill_symtitle">
                            <i class="fa fa-heart-o" aria-hidden="true"></i>
            ...
            <!-- 作品 -->
            <div class="portfolio">
                <p class="por_title col-12 text-right" data-text="Contact Me." id="por" data-aos="fade-left"
                    data-aos-delay="170" data-aos-duration="1000">Portfolio.</p>
                <div class="work_line offset-9 col-3"></div>
                <div class="por_text">
...
-->
            ...
            <div class="contact_me d-flex">
                <div class="title_email col-12 text-center" data-text="Contact Me." id="email" data-aos="fade-down"
                    data-aos-delay="170" data-aos-duration="1000">Contact Me.
